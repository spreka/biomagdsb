function [y, p] = sacPredict_RandomTree_Weka(classifier, data)
% [y, p] = sacPredict_RandomTree_Weka(classifier, data)
% Applies a classifier that considers K randomly chosen attributes per 
...
%  
% See also: sacTrain_RandomTree_Weka, sacPredict sacNormalizeData
