function [y, p] = sacPredict_RandomForest_Weka(classifier, data)
% [y, p] = sacPredict_RandomForest_Weka(classifier, data)
% Applies a random forest classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_RandomForest_Weka, sacPredict, sacNormalizeData
