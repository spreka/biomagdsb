function [y, p] = sacPredict_LogisticRegression_Weka(classifier, data)
% [y, p] = sacPredict_Logistic_Weka(classifier, data)
% Applies a logistic regression classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_Logistic_Weka, sacPredict, sacNormalizeData
