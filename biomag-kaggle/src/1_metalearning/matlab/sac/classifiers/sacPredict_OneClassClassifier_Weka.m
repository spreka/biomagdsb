function [y, p] = sacPredict_OneClassClassifier_Weka(classifier, data)
% [y, p] = sacPredict_KNN_Weka(classifier, data)
% Applies a K-nearest neighbors classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_KNN_Weka, sacTrain, sacNormalizeData
