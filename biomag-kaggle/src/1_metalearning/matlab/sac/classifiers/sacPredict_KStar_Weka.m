function [y, p] = sacPredict_KStar_Weka(classifier, data)
% [y, p] = sacPredict_KStar_Weka(classifier, data)
% Applies a K* classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_KStar_Weka, sacTrain, sacNormalizeData
