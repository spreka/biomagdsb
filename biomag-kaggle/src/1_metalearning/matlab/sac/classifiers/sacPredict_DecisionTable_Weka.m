function [y, p] = sacPredict_DecisionTable_Weka(classifier, data)
% [y, p] = sacPredict_BayesNet_Weka(classifier, data)
% Applies a Bayes net classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_BayesNet_Weka, sacTrain, sacNormalizeData
