function [y, p] = sacPredict_NaiveBayes_Weka(classifier, data)
% [y, p] = sacPredict_NaiveBayes_Weka(classifier, data)
% Applies a naive bayes classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_NaiveBayes_Weka, sacTrain, sacNormalizeData
