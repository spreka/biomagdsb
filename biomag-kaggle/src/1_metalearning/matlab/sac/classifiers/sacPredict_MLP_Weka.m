function [y, p] = sacPredict_MLP_Weka(classifier, data)
% [y, p] = sacPredict_MLP_Weka(classifier, data)
% Applies a multilayer perceptron classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_MLP_Weka, sacTrain, sacNormalizeData
