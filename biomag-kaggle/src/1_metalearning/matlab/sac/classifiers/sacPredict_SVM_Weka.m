function [y, p] = sacPredict_SVM_Weka(classifier, data)
% [y, p] = sacPredict_SVM_Weka(classifier, data)
% Applies an SVM classifier using the WEKA library to data. 
%
% INPUT:
...
%
% See also: sacTrain_SVM_Weka, sacPredict, sacNormalizeData
