...
resultsFile = 'd:\Projects\Data Science Bowl 2018\data\contest\20180409\paramsearchresult_original.txt';
...
erosionRadii = 0 %[0:4];
dilationRadii = 2 %[0:4];
minSizes = [30 40 50]%[5:5:75];
scaleThreshs = 14 %[10:30];
% probThresholds = 8656;
probThresholds = 8656 %[8656-500:100:8656+500];
