...
inFolder = '/ssd/spreka/mrcnn_output/';
inProbmapFolders = {'/ssd/spreka/mrcnn_output/ensemble/validation/'};
outFolder = '/ssd/spreka/mrcnn_output/postprocessing/paramsearch/results/';
resultsFile = '/ssd/spreka/mrcnn_output/postprocessing/paramsearch/results/paramsearchresult.txt';
...
smallScaleImagesFolder.name = fullfile(inFolder, 'largeAug_0618_conf06_val', '');

bigScaleImagesFolder.scale = 2;
bigScaleImagesFolder.name = fullfile(inFolder, 'largeAug_0618_conf06_val4x', '');
