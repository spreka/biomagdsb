...
python %maskrcnn_scripts%\\segmentation.py %maskrcnn%\config\predict\presegment_val.json
IF %ERRORLEVEL% NEQ 0 (
...
python %maskrcnn_scripts%\\segmentation.py %maskrcnn%\config\predict\segmentation_params_2x_val.json
IF %ERRORLEVEL% NEQ 0 (
...
python %maskrcnn_scripts%\\segmentation.py %maskrcnn%\config\predict\segmentation_params_4x_val.json
IF %ERRORLEVEL% NEQ 0 (
    echo ERROR: "Error during maskrcnn prediction"
    exit /B 6
)
